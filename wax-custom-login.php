...
function wax_login_head() {
  ...
  $wax_theme_screenshot = $wax_active_theme->get_screenshot();
	?>
    <style>body.login #login h1 a{background:url('<?php echo $wax_theme_screenshot; ?>') no-repeat scroll center top transparent;width:300px;height:300px;background-size:170%;border-radius:50%;box-shadow:inset 0 0 3px rgba(0,0,0,.5);margin-bottom:3rem}</style>
  <?php
}
